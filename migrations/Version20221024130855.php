 ...
 */
final class Version20221024130855 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE subsidiary_permission (subsidiary_id INT NOT NULL, permission_id INT NOT NULL, INDEX IDX_9B3AECF9D4A7BDA2 (subsidiary_id), INDEX IDX_9B3AECF9FED90CCA (permission_id), PRIMARY KEY(subsidiary_id, permission_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
